...
public class SequenceGenerator {
    ...
    private static class SequenceGeneratorLoader {

        private static final SequenceGenerator INSTANCE = new SequenceGenerator();
    }

    public static SequenceGenerator getInstance() {
        return SequenceGeneratorLoader.INSTANCE;
    }

    // Custom Epoch (January 1, 2015 Midnight UTC = 2018-12-01T00:00:00Z)
//    private static final long CUSTOM_EPOCH = 1420070400000L;
    private static final long CUSTOM_EPOCH = 1543622400000L;
